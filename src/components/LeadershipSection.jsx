    ...
    <section className="grid md:grid-cols-2">
      <div className="relative flex min-h-[430px] flex-col justify-between overflow-hidden bg-brand-ink px-6 py-12 text-white md:px-12">
        ...
        <p className="relative max-w-md text-lg leading-8 text-white/70">
          Seasoned builders behind MENA Insurtech Summit and Africa Insurtech
          Rising, with networks spanning GCC sovereign, global insurance, and
          Sub-Saharan markets.
        </p>
      </div>
      ...
      <div className="flex min-h-[430px] flex-col justify-end bg-[#edf0f1] px-6 py-12 md:px-12">
        <div className="grid gap-8 sm:grid-cols-2">
          {founders.map((founder) => (
            <article
              key={founder.name}
              className="african-card rounded-[24px] border border-brand-ink/10 bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(6,31,40,0.12)]"
            >
