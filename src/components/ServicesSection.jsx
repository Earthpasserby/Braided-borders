      ...
      <div className="relative mx-auto max-w-[1200px]">
        <div className="mb-14 grid gap-8 md:grid-cols-[0.72fr_1.28fr] md:items-end">
          ...
          <div className="animate-rise">
            <h2 className="text-display text-4xl leading-[0.98] tracking-[-0.04em] sm:text-5xl md:text-7xl">
              Strategic work
              <br />
              <em>that moves.</em>
            </h2>
        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            {capabilities.map((capability, index) => (
              <article
                key={capability}
                className="group flex items-center justify-between gap-3 rounded-[24px] border border-white/10 bg-white/[0.03] px-4 py-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-sand/40 hover:bg-white/[0.05] sm:gap-5 sm:px-5 sm:py-5 md:px-7 md:py-6"
              >
                <div className="flex min-w-0 items-center gap-3 sm:gap-5">
                  ...
                  <p className="min-w-0 text-lg leading-7 text-white/90 sm:text-xl md:text-2xl">
                    {capability}
                  </p>
                </div>
