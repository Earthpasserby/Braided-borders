            ...
            <div className="grid gap-10 md:grid-cols-[0.95fr_1.05fr] md:gap-12">
              <div className="animate-rise">
                ...
                <div className="mt-8 rounded-[26px] border border-white/10 bg-[#0b202b]/80 p-5 md:p-7">
                  ...
                  <p className="mt-5 text-lg leading-8 text-white/75 md:text-2xl">
                    Good deal logic is not enough in markets where channel
                    access, licensing nuance, and local trust determine whether
                    a plan can move at all.
                  </p>
                </div>
              </div>
              ...
              <div className="animate-rise">
                ...
                <p className="mt-8 max-w-xl text-lg leading-8 text-white/65">
                  ...
                  real operating environment, and turn complexity into a
                  practical path to growth before it becomes a costly surprise.
                </p>
              </div>
            </div>
          </div>
